<%@ Page Title="" Language="C#" MasterPageFile="~/dashboardMasterPage.master" AutoEventWireup="true" CodeFile="Livemeter.aspx.cs" Inherits="Livemeter" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <h5>
        ...
        <asp:Label ID="Label9" runat="server" Text="Live Meter Readings" 
       ...
       <table>
        <tr >
            <td>
                <asp:Label ID="Label1" runat="server" Text="Master Node" ForeColor="Black"></asp:Label>
                   </td>
 <td>
            <asp:DropDownList ID="drpMaster" runat="server">
                ...
                <asp:ListItem>MasterNode10</asp:ListItem>
                 ...
                 <asp:Label ID="Label2" runat="server" Text="Node" ForeColor="Black"></asp:Label>
                   </td>
                    <td>

                     
                <asp:DropDownList ID="drpNode" runat="server">
                ...
                <asp:Button ID="btnGet" runat="server" Text="Get" Width="64px" OnClick="btnGet_Click" />  
                   </td>
                    </tr>
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/CityLevel.aspx">back to dashboard</asp:HyperLink>
</asp:Content>
