<%@ Page Title="" Language="C#" MasterPageFile="~/edoctormasterpage.master" AutoEventWireup="true" CodeFile="ask-a-doctor-online.aspx.cs" Inherits="ask_a_doctor_online" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div  style="width: 1200px; height: 450px">
        <asp:Label ID="lblreply" runat="server" 
               ...
               style="z-index: 1; left: 800px; top: 704px; position: absolute" 
               ForeColor="#9900CC"></asp:Label>
        <asp:TextBox ID="txtemail" runat="server" 
               style="z-index: 1; left: 327px; top: 786px; position: absolute; width: 287px; height: 34px" 
        ...
        <asp:TextBox ID="txthealthentry" runat="server" 
               style="z-index: 1; left: 77px; top: 551px; position: absolute; width: 729px; height: 101px" 
        ...
        <asp:Button ID="btnExisting" runat="server" BackColor="#416A92" 
            ...
            style="z-index: 1; left: 73px; top: 791px; position: absolute; width: 105px; height: 39px;" 
            Text="Existing User" />
        
        <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="~/images/div/ask_a_doctor_online.png"  
               
            style="z-index: 1; left: 51px; top: 186px; position: absolute; height: 357px; width: 806px;" 
            BorderColor="#669999" />
      
        <asp:ImageButton ID="ImageButton4" runat="server" 
               ImageUrl="~/images/div/submit_Continue.png" OnClick="ImageButton1_Click" 
               
            style="z-index: 1; left: 753px; top: 841px; position: absolute; height: 56px; width: 236px;" />
           <asp:DropDownList ID="drpspeciality" runat="server" 
            style="z-index: 1; left: 77px; top: 683px; position: absolute; height: 46px; width: 727px">
...
<asp:ListItem>Yoga</asp:ListItem>
        ...
        <asp:Label ID="lblmobilenumber" runat="server" Text="Mobile Number" 
            ...
            style="z-index: 1; left: 647px; top: 741px; position: absolute"></asp:Label>
        <asp:Label ID="Label11" runat="server" Text="Your Name" 
            Font-Names="Gill Sans MT" 
            style="z-index: 1; left: 195px; top: 740px; position: absolute"></asp:Label>
        <asp:TextBox ID="txtpassword" runat="server" 
               style="z-index: 1; left: 327px; top: 835px; position: absolute; width: 287px; height: 34px; right: 667px;" 
        ...
        <asp:TextBox ID="txtname" runat="server" 
               style="z-index: 1; left: 327px; top: 733px; position: absolute; width: 287px; height: 34px" 
               BorderColor="#669999" BorderStyle="Solid" BorderWidth="1px" ontextchanged="TextBox4_TextChanged"></asp:TextBox>
        <asp:Label ID="Label12" runat="server" Text="Your Email" 
            Font-Names="Gill Sans MT" 
            style="z-index: 1; left: 195px; top: 791px; position: absolute"></asp:Label>
        <asp:HyperLink ID="hyplinkforgot" runat="server" ForeColor="#003399" 
            
            style="z-index: 1; left: 70px; top: 846px; position: absolute; right: 1102px; width:115px">Forgot Password?</asp:HyperLink>
        <asp:Button ID="btnnew0" runat="server" BackColor="#339966" BorderStyle="None" 
            ForeColor="White" onclick="btnnew0_Click" 
            style="z-index: 1; left: 73px; top: 751px; position: absolute; width: 108px; height: 34px;" 
            Text="New User" />
        <asp:Label ID="lblchoosepwd0" runat="server" Text="Choose a Password" 
            Font-Names="Gill Sans MT" 
            style="z-index: 1; left: 191px; top: 844px; position: absolute"></asp:Label>
           <asp:DropDownList ID="drpmobile" runat="server" 
            style="z-index: 1; left: 647px; top: 777px; position: absolute; height: 44px; width: 136px" OnSelectedIndexChanged="drpmobile_SelectedIndexChanged">
