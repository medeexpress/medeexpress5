<%@ Page Title="" Language="C#" MasterPageFile="~/dashboardMasterPage.master" AutoEventWireup="true" CodeFile="inputpower.aspx.cs" Inherits="inputpower" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <h5>
        ...
        <asp:Label ID="Label9" runat="server" Text="Input Power" 
