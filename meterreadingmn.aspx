<%@ Page Title="" Language="C#" MasterPageFile="~/dashboardMasterPage.master" AutoEventWireup="true" CodeFile="meterreadingmn.aspx.cs" Inherits="meterreadingmn" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <h5>
        ...
        <asp:Label ID="Label9" runat="server" Text="Meter Reading Of Particular Master Node" 
     ...
     <asp:Button ID="btnPrint" runat="server" Text="Print" Width="64px"  />  
          <div>
